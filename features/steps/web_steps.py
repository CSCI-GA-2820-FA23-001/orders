...
@then('I should see "{text_string}" in the "{prefix}" "{element_name}" field')
def step_impl(context, text_string, prefix, element_name):
    element_id = element_name.lower().replace(" ", "_")
    if prefix == "Order":
        element_id = ORDER_ID_PREFIX + element_id
    else:
...
@when('I change "{prefix}" "{element_name}" to "{text_string}"')
def step_impl(context, prefix, element_name, text_string):
    element_id = element_name.lower().replace(" ", "_")
    if prefix == "Order":
        element_id = ORDER_ID_PREFIX + element_id
